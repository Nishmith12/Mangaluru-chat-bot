    ...
    async function getBotResponse(userInput) {
        ...
        const prompt = `
            ...
            6.  "CHITCHAT": The user is making small talk (e.g., "hello", "how are you?", "what's your name?").
            7.  "UNKNOWN_QUERY": The user is asking about a specific Mangalorean topic that you don't have data for (e.g., "Tannirbhavi Beach", "Pilikula Nisargadhama").
